function schema
    ...
    c = schema.class(pk, 'abstractellip', parent);
    set(c, 'Description', 'abstract');
    % 12 13
    p = schema.prop(c, 'MatchExactly', 'passstoporboth');
    ...
    % 22 24
    % 23 24
    p = schema.prop(c, 'privMatchExactly', 'passstoporboth');
    set(p, 'FactoryValue', 'both', 'AccessFlags.PublicSet', 'Off', 'AccessFlags.PublicGet', 'Off');
    % 26 28
    % 27 28
end % function
