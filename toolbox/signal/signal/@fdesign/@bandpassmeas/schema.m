function schema
    ...
    c = schema.class(pk, 'bandpassmeas', pk.findclass('abstractmeas'));
    % 10 11
    ...
    set(p, 'AccessFlags.PublicSet', 'Off');
    % 34 35
    p = schema.prop(c, 'Astop1', 'mxArray');
    set(p, 'AccessFlags.PublicSet', 'Off');
    % 37 38
    p = schema.prop(c, 'Apass', 'mxArray');
    set(p, 'AccessFlags.PublicSet', 'Off');
    % 40 41
    p = schema.prop(c, 'Astop2', 'mxArray');
    set(p, 'AccessFlags.PublicSet', 'Off');
    % 43 44
...
function tw = get_transitionwidth1(this, tw)
    % 51 53
    % 52 53
    tw = minus(get(this, 'Fpass1'), get(this, 'Fstop1'));
end % function
function tw = get_transitionwidth2(this, tw)
    % 56 58
    % 57 58
    tw = minus(get(this, 'Fstop2'), get(this, 'Fpass2'));
end % function
