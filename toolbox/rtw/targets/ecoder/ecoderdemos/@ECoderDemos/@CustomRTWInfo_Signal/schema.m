function schema
    ...
    if isempty(findtype('ECoderDemos_CustomStorageClassList_for_Signal'))
        ...
        warning('A type named ''ECoderDemos_CustomStorageClassList_for_Signal'' already exists.');
    end % if
    % 33 35
    % 34 35
    hThisProp = schema.prop(hThisClass, 'CustomStorageClass', 'ECoderDemos_CustomStorageClassList_for_Signal');
    % 36 38
    % 37 38
