function schema
    ...
    % 21 23
    % 22 23
    hThisClass = schema.class(hCreateInPackage, 'AmplifyRTWInfo', hDeriveFromClass);
    hThisClass.Handle = hDeriveFromClass.Handle;
    % 25 27
    % 26 27
    hThisProp = schema.prop(hThisClass, 'CustomStorageClass', 'AmplifyStorageClass');
    hThisProp.AccessFlags.Init = 'on';
    hThisProp.FactoryValue = 'AmplifyVariant';
    % 30 32
    % 31 32
