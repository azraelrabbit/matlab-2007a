function differences = compareComponentWithChild(h, h2)
    ...
    % 8 10
    % 9 10
    compatibleFields = cellhorzcat(compatibleFields{:}, 'ExtModeTransport', 'ExtModeStaticAlloc', 'ExtModeStaticAllocSize', 'ExtModeTesting', 'ExtModeMexFile', 'ExtModeMexArgs', 'ExtModeIntrfLevel');
    % 11 15
    % 12 15
    % 13 15
    % 14 15
