function initialize(this, ax, gridsize)
    ...
    % 12 15
    % 13 15
    this.AxesGrid = hdsviewer.axesgrid(gridsize, ax, 'Visible', 'off', 'Geometry', geometry, 'YLimSharing', 'all', 'XLimSharing', 'all', 'LimitFcn', cellhorzcat(@updatelims, this), 'Title', 'Waterfall Plot', 'XLabel', '', 'YLabel', '', 'XUnit', '');
    % 15 26
    % 16 26
    % 17 26
    % 18 26
