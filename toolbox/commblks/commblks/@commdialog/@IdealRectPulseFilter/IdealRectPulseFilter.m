function this = IdealRectPulseFilter(block)
    % 1 9
    % 2 9
    % 3 9
    % 4 9
    ...
    % 7 9
    % 8 9
    this = commdialog.IdealRectPulseFilter(block);
    % 10 11
    this.init(block);
    % 12 13
