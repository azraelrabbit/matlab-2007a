function cm = getContextMenu(this, selectedHandles)
    ...
    if isLibrary(this)
        ...
        % 17 19
        % 18 19
        cm.addMenuItem(am.createAction(e, 'Text', xlate('Add property'), 'Callback', 'exploreAction(subsref(getSelectedListNodes(DAStudio.imExplorer(getEditor(RptgenML.Root))),substruct(''()'',{1})));', 'StatusTip', xlate('')));
    else
        % 21 23
        % 22 23
        % 23 25
