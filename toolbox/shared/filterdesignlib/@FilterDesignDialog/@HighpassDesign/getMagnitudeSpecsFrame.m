function mspecs = getMagnitudeSpecsFrame(this)
    ...
    if hasapass || hasastop
        ...
        % 22 24
        [items, col] = addConstraint(this, 3.0, 1.0, items, hasastop, 'Astop', 'Astop', 'Stopband attenuation');
        % 24 26
        items = addConstraint(this, 3.0, col, items, hasapass, 'Apass', 'Apass', 'Passband ripple');
    else
        % 27 31
        % 28 31
        % 29 31
