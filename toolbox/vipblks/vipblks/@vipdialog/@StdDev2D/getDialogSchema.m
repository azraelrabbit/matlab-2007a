function dlgStruct = getDialogSchema(this, dummy)
    ...
    % 12 14
    % 13 14
    run = dspGetLeafWidgetBase('checkbox', 'Running standard deviation', 'run', this, 'run');
    run.RowSpan = [1.0 1.0];
    run.ColSpan = [1.0 1.0];
    ...
    parametersGroup.RowSpan = [2.0 2.0];
    ...
    % 132 134
    % 133 134
    dlgStruct = this.getBaseSchemaStruct(mainTabItems);
    % 135 136
    dlgStruct.Items{1.0}.LayoutGrid = [4.0 1.0];
    dlgStruct.Items{1.0}.RowStretch = [0.0 0.0 0.0 1.0];
end % function
