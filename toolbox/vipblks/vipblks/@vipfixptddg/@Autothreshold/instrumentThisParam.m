function doThisOne = instrumentThisParam(this, SignalName, ParamName)
    ...
    case 'Accumulator 4'
        if any(strcmp(ParamName, {'A4Mode','A4WordLength'}))
            doThisOne = true;
        end % if
    case 'Product 1'
    ...
    case 'Product 4'
        if any(strcmp(ParamName, {'P4Mode','P4WordLength'}))
            doThisOne = true;
        end % if
    case 'EffMetric'
        if any(strcmp(ParamName, {'EMMode','EMWordLength'}))
            doThisOne = true;
        end % if
    case 'Quotient'
        if any(strcmp(ParamName, {'Q1Mode','Q1WordLength'}))
            doThisOne = true;
        end % if
    end % switch
