function this = ModelSimHDLInstantiation(block)
    ...
    % 9 11
    % 10 11
    this = hdldefaults.ModelSimHDLInstantiation;
    % 12 13
    ...
    % 18 20
    % 19 20
    desc = struct('ShortListing', 'ModelSim HDL instantiation', 'HelpText', 'ModelSim code generation via direct HDL instantiation');
    % 21 24
    % 22 24
    % 23 24
