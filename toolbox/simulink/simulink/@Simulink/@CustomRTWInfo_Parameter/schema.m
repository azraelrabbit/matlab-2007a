function schema
    ...
    if isempty(findtype('Simulink_CustomStorageClassList_for_Parameter'))
        ...
        warning('A type named ''Simulink_CustomStorageClassList_for_Parameter'' already exists.');
    end % if
    % 33 35
    % 34 35
    hThisProp = schema.prop(hThisClass, 'CustomStorageClass', 'Simulink_CustomStorageClassList_for_Parameter');
    % 36 38
    % 37 38
